        ...
        <div className="about-page">
            ...
            <section className="about-sections">
                ...
                >
                    ...
                    >
                        泰州优库冷库设备有限公司是集产品设计、产品开发、产品制造、工程成套、售后服务、技术咨询为一体的综合性公司。公司以生产和定制各种组合式冷库为主导,专业安装组合式冷冻库、速冻库、冷藏库、保鲜库、气调库、实验库、防爆库、冷链物流设备和超低温(0℃至-120℃)库等并提供制冷设备,满足客户的各种需要。产品广泛的应用于食品、医疗卫生、制药、生物工程、水产品、农产品、超市、电子、酒店、化工、服务业等各类行业。在自身发展的过程中,本公司始终本着以人为本,以科技促发展的经营理念,与上海农科院、上海水产大学、上海蔬菜研究院、上海同济建筑设计院等多所大学及科研机构联合协作,致力于产品的开发研究。同时也打造出一支工作经验丰富、服务体系完善的施工队伍,为客户提供优质的服务。
                    </motion.p>
                </motion.div>
